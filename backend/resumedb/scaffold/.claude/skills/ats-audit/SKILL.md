...
2. Extract the skills, technologies, qualifications, and role-specific terms the
   JD actually asks for (ignore boilerplate benefits/EEO text, additionally ignore requirements that do not belong in a resume (e.g. "Citizenship Status, Work Authorization")).
